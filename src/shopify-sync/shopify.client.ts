...
/** Credenciales de una tienda Shopify — vienen de la DB por empresa */
...
/** Construye un ShopifyConfig desde una fila de companies */
export function shopifyConfigFromCompany(company: {
  id: string;
  shopify_store: string | null;
  shopify_token: string | null;
  shopify_location_id: string | null;
}): ShopifyConfig | null {
  if (!company.shopify_store || !company.shopify_token || !company.shopify_location_id) return null;
  return {
    store: company.shopify_store,
    token: company.shopify_token,
    locationId: company.shopify_location_id,
